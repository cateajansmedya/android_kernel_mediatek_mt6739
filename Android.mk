...
ifneq ($(strip $(TARGET_NO_KERNEL)),true)
    ...
    HCT_KERNEL_CONFIG_FILE:=$(KERNEL_DIR)/arch/$(TARGET_ARCH)/configs/hct_kernel_config
...
$(TARGET_KERNEL_CONFIG): $(KERNEL_CONFIG_FILE) $(LOCAL_PATH)/Android.mk $(HCT_KERNEL_CONFIG_FILE)
$(TARGET_KERNEL_CONFIG): $(shell find $(KERNEL_DIR) -name "Kconfig*")
	$(hide) $(call cp-hct-config-to-kernel-config,$(HCT_KERNEL_CONFIG_FILE),$(KERNEL_CONFIG_FILE))
