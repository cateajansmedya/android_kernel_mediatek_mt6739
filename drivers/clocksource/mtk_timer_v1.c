...
static unsigned long gpt_clkevt_last_cycles;
static unsigned long gpt_clkevt_last_cycles_cpu;
				   ...
				   struct clock_event_device *evt)
{
	...
	gpt_clkevt_last_cycles = cycles;
	gpt_clkevt_last_cycles_cpu = smp_processor_id();
#endif
	return 0;
}
