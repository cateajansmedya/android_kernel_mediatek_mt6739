...
#if CFG_SHOW_MACADDR_SOURCE
			DBGLOG(INIT, INFO, "dynamically read %x %x %x %x %x %x",rMacAddr[0],rMacAddr[1],rMacAddr[2],rMacAddr[3],rMacAddr[4],rMacAddr[5]);
#endif
...
#if CFG_SHOW_MACADDR_SOURCE
				DBGLOG(INIT, INFO, "dynamically write%x %x %x %x %x %x",rMacAddr[0],rMacAddr[1],rMacAddr[2],rMacAddr[3],rMacAddr[4],rMacAddr[5]);
#endif
			}
	} else {
#if CFG_SHOW_MACADDR_SOURCE
