...
#include "hi2907mipi_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "hi2907_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = HI2907_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
{	
	...
	SIOSENSOR_INFO(" hi2907 add0205 gain = %x\n",(iReg & 0xFF));
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x3009,0x04); //02
	write_cmos_sensor(0x300b,0x04);//03
...
UINT32 HI2907_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    hi2907MIPI_RAW_SensorInit    */
