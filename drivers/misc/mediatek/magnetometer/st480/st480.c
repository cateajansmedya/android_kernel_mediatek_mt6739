...
{
	*x = st480sensordata.yaw / 1000;
	*y = st480sensordata.pitch / 1000;
	*z = st480sensordata.roll / 1000;
	*status = st480sensordata.mag_status;
	MSE_ERR("%s, data:%d,%d,%d\n", __func__, st480sensordata.yaw, st480sensordata.pitch,
		st480sensordata.roll);
	return 0;
}
