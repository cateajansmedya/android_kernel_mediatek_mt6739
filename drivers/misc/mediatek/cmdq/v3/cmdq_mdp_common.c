...
void cmdq_mdp_dump_rot(const unsigned long base, const char *label)
{
	...
	CMDQ_REG_SET32(base + 0x018, 0x00002200);
	value[43] = CMDQ_REG_GET32(base + 0x0D0);
	CMDQ_REG_SET32(base + 0x018, 0x00002300);
	value[44] = CMDQ_REG_GET32(base + 0x0D0);
	CMDQ_REG_SET32(base + 0x018, 0x00002400);
	value[45] = CMDQ_REG_GET32(base + 0x0D0);
	CMDQ_REG_SET32(base + 0x018, 0x00002500);
	value[46] = CMDQ_REG_GET32(base + 0x0D0);
	CMDQ_REG_SET32(base + 0x018, 0x00002600);
	value[47] = CMDQ_REG_GET32(base + 0x0D0);
	CMDQ_REG_SET32(base + 0x018, 0x00002700);
	value[48] = CMDQ_REG_GET32(base + 0x0D0);
	CMDQ_REG_SET32(base + 0x018, 0x00002800);
	value[49] = CMDQ_REG_GET32(base + 0x0D0);

	value[50] = CMDQ_REG_GET32(base + 0x01C);
	value[51] = CMDQ_REG_GET32(base + 0x07C);
	value[52] = CMDQ_REG_GET32(base + 0x010);
	value[53] = CMDQ_REG_GET32(base + 0x014);
	...
	CMDQ_ERR("ROT_DMA_PERF: 0x%08x, ROT_STRIDE: 0x%08x, ROT_IN_SIZE: 0x%08x\n",
		 value[6], value[7], value[8]);
	CMDQ_ERR("ROT_EOL: 0x%08x, DBG_1: 0x%08x, DBG_2: 0x%08x\n",
		 value[9], value[10], value[11]);
	CMDQ_ERR("DBG_3: 0x%08x, DBG_4: 0x%08x, DBG_5: 0x%08x, DBG_6: 0x%08x\n",
		 value[12], value[13], value[14], value[15]);
	CMDQ_ERR("DBG_7: 0x%08x, DBG_8: 0x%08x, DBG_9: 0x%08x, DBG_A: 0x%08x\n",
		 value[16], value[17], value[18], value[19]);
	CMDQ_ERR("DBG_B: 0x%08x, DBG_C: 0x%08x, DBG_D: 0x%08x, DBG_E: 0x%08x\n",
		 value[20], value[21], value[22], value[23]);
	CMDQ_ERR("DBG_F: 0x%08x, DBG_10: 0x%08x, DBG_11: 0x%08x, DBG_12: 0x%08x\n",
		 value[24], value[25], value[26], value[27]);
	CMDQ_ERR("DBG_13: 0x%08x, DBG_14: 0x%08x, DBG_15: 0x%08x, DBG_16: 0x%08x\n",
		 value[28], value[29], value[30], value[31]);
	CMDQ_ERR("DBG_17: 0x%08x, DBG_18: 0x%08x, DBG_19: 0x%08x, DBG_1A: 0x%08x\n",
		 value[32], value[33], value[34], value[35]);
	CMDQ_ERR("DBG_1B: 0x%08x, DBG_1C: 0x%08x, DBG_1D: 0x%08x, DBG_1E: 0x%08x\n",
		 value[36], value[37], value[38], value[39]);
	CMDQ_ERR("DBG_1F: 0x%08x, DBG_20: 0x%08x, DBG_21: 0x%08x, DBG_22: 0x%08x\n",
		 value[40], value[41], value[42], value[43]);
	CMDQ_ERR("DBG_23: 0x%08x, DBG_24: 0x%08x, DBG_25: 0x%08x, DBG_26: 0x%08x\n",
		 value[44], value[45], value[46], value[47]);
	CMDQ_ERR("DBG_27: 0x%08x, DBG_28: 0x%08x VIDO_INT: 0x%08x, VIDO_ROT_EN: 0x%08x\n",
