...
#define LCM_NAME "RM69330_454x454_dsi_cmd_oled"
...
static int change_backlight = 1, lcm_sync = 0;
...
static struct LCM_setting_table lcm_sync_setting[] = {
	{0xFE, 0x01, {0x04}},
	{0x66, 0x01, {0x05}},
	{0xFE, 0x01, {0x00}},
	{REGFLAG_END_OF_TABLE, 0x00, {}}
...
static void lcm_set_backlight(void* handle, unsigned int level) {
	...
	if (!lcm_sync) {
		lcm_sync = 1;
		push_table(lcm_sync_setting, sizeof(lcm_sync_setting) / sizeof(struct LCM_setting_table), 1);
	}
...
LCM_DRIVER RM69330_454x454_dsi_cmd_oled_drv = {
	.name = LCM_NAME,
