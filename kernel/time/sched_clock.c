...
static int sched_clock_suspend(void)
{
	...
	/*
	 * mtk patch:
	 * insert a new time synchronization base: suspended sched_clock and
	 * sys_timer tick.
	 */
	sys_timer_timesync_update_base(1);
...
static void sched_clock_resume(void)
{
	...
	/*
	 * mtk patch:
	 * insert a new time synchronization base: resumed sched_clock and
	 * sys_timer tick.
	 */
